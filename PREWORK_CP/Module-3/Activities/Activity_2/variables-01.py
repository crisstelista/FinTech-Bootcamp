...
statement_one = '"' + subject + ': ' + first_name + ' is a ' + nationality + " " + profession + ' born in ' + str(birth_year) + '."'
...
statement_three = '"In '+ str(year_of_publish) + ' she published the first Algorithm, the Analytical Engine, at the age of ' \
                  + str(year_of_publish - birth_year) +'."'
...
statement_four = '"She was a ' + nationality + ' Citizen who lived in ' + city_location + ', ' + country_location \
                 + ' until her passing in ' + str(death_year) + ' at the age of ' + str(death_year - birth_year) + '."'
